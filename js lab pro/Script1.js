document.getElementById("Love Calculator").addEventListener('click', () => {
...
document.getElementById("Body mass index").addEventListener('click', () => {
...
document.getElementById("Year vis").addEventListener('click', () => {
...
document.getElementById("Who pays").addEventListener('click', () => {
